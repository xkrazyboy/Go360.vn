...
use WilokeListingTools\MetaBoxes\Coupon;
...
$buttonLink = GetSettings::getPostMeta($post->ID, 'coupon');
						...
						<div class="listing-detail_left__22FMI">
							<div class="listing-detail_goo__1A8J-">
								<div class="listing-detail_logo__3fI4O bg-cover" style="background-image: url(<?php echo esc_url($logo); ?>);">
									<a href="<?php echo esc_url($buttonLink['redirect_to']); ?>"><img class="hidden" src="<?php echo esc_url($logo); ?>" alt="<?php echo esc_attr($post->post_title);  ?>"></a>
								</div>
							</div>
