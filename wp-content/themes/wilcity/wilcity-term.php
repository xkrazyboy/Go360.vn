                                            ...
                                            <div class="listing_firstWrap__36UOZ">
                                                <header class="listing_header__2pt4D">
                                                    <a href="<?php echo esc_url(get_permalink($query->post->ID)); ?>">
														<div class="listing_img__3pwlB pos-a-full bg-cover" style="background-image: url('<?php echo esc_url($featuredImg); ?>')">
														<img src="<?php echo esc_url($featuredImg); ?>" alt="<?php echo esc_attr($query->post->post_title); ?>">
														</div>
                                                    </a>
                                                </header>
