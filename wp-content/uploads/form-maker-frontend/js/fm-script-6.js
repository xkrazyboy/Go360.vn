    ...
    var required_fields6 = ["2","8","3","7","10"];
    var labels_and_ids6 = {"2":"type_text","8":"type_phone_new","3":"type_submitter_mail","9":"type_editor","7":"type_checkbox","10":"type_checkbox","5":"type_textarea","1":"type_submit_reset"};
 ...
 function after_submit6() {
    ...
    function onsubmit_js6() {
				  ...
				  jQuery("<input type=\"hidden\" name=\"wdform_7_allow_other6\" value=\"yes\" />").appendTo("#form6");
				  jQuery("<input type=\"hidden\" name=\"wdform_7_allow_other_num6\" value=\"6\" />").appendTo("#form6");
				  jQuery("<input type=\"hidden\" name=\"wdform_10_allow_other6\" value=\"yes\" />").appendTo("#form6");
				  jQuery("<input type=\"hidden\" name=\"wdform_10_allow_other_num6\" value=\"6\" />").appendTo("#form6");
    var disabled_fields = "";
